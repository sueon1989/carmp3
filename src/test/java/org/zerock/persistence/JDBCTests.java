...
//			Class.forName("org.mariadb.jdbc.Driver");			// MariaDB
	...
	public void testConnection() {
		// try(자동으로 닫을 자원)
		try(Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@192.168.0.11:1521:XE", "book_ex", "book_ex")){
	...
	public void testConnection_MariaDB() {
		// try(자동으로 닫을 자원) 
		try(Connection conn = DriverManager.getConnection("jdbc:mariadb://192.168.0.11:3306/book_ex", "book_ex", "book_ex")){
